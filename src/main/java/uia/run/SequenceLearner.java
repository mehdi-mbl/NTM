...
import uia.learn.BackPropagation;
import uia.learn.RMSPropWeightUpdater;
import uia.learn.RandomWeightInitializer;
...
abstract public class SequenceLearner {
    ...
    private final BackPropagation teacher;
    ...
    public SequenceLearner(int vectorSize, int memoryWidth, int memoryHeight, int numHeads, int controllerSize, ActivationFunction activationFunction) {
...
//        final int controllerSize = 128;
        ...
        teacher = new BackPropagation(machine,
    ...
    public void run(boolean verbose) {
        ...
        onTrained(i, sequence, output, trainTimeNS, averageError, verbose);
