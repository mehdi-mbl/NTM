...
public class HiddenLayer   
{
    ...
    public HiddenLayer(int controllerSize, int inputSize, int headCount, int memoryUnitSizeM, ActivationFunction activation) {
        inputs = inputSize;
        heads = headCount;
    ...
    private HiddenLayer(Unit[][][] readDataToHiddenLayerWeights, UMatrix inputToHiddenLayerWeights, UVector hiddenLayerThresholds, UVector hiddenLayer, int inputSize, int headCount, int memoryUnitSizeM, ActivationFunction activationFunction) {
