...
public class FeedForwardController   
{
    ...
    public FeedForwardController(int controllerSize, int inputSize, int outputSize, int headCount, int memoryUnitSizeM, ActivationFunction activationFunction) {
        this(new HiddenLayer(controllerSize,inputSize,headCount,memoryUnitSizeM, activationFunction),
                new OutputLayer(outputSize,controllerSize,headCount,memoryUnitSizeM, activationFunction));
    }
