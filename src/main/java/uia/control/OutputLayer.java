...
public class OutputLayer {
    ...
    public OutputLayer(int outputSize, int controllerSize, int headCount, int memoryUnitSizeM, ActivationFunction activationFunction) {
    ...
    private OutputLayer(Unit[][] hiddenToOutputLayerWeights, Unit[][][] hiddenToHeadsWeights, UVector outputs, Head[] heads, int outputSize, int controllerSize, int memoryWidth, int headUnitSize, ActivationFunction activationFunction) {
    ...
    public void forwardPropagation(HiddenLayer hiddenLayer) throws NullPointerException {
        ...
        for (int i = 0; i < _outputSize; i++) {
            ...
            out[i] = activationFunction.getValue(sum);
        }
    ...
    public OutputLayer clone() {
        ...
        return new OutputLayer(_hiddenToOutputLayerWeights, _hiddenToHeadsWeights,
                new UVector(_outputSize), heads, _outputSize, controllerSize, memoryWidth, _headUnitSize, activationFunction);
