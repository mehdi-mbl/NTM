package uia.ntm.memory;

import uia.ntm.control.UVector;
import uia.ntm.control.Unit;
import uia.ntm.memory.address.GatedAddressing;
import uia.ntm.memory.address.Head;
import uia.ntm.memory.address.ShiftedAddressing;
import uia.ntm.memory.address.content.BetaSimilarity;
import uia.ntm.memory.address.content.ContentAddressing;
import uia.ntm.memory.address.content.CosineSimilarityFunction;
import uia.ntm.memory.address.content.SimilarityMeasure;
