...
public class GatedAddressing   
{
    ...
    public GatedAddressing(Unit gate, ContentAddressing contentAddressing, HeadSetting oldHeadSettings, ActivationFunction activationFunction) {
        this.gate = gate;
        ...
        gt = activationFunction.getValue(this.gate.value);
