...
public class ShiftedAddressing
{
    ...
    public ShiftedAddressing(Unit shift, GatedAddressing gatedAddressing, ActivationFunction activationFunction) {
        _shift = shift;
        ...
        shiftWeight = activationFunction.getValue(_shift.value);
